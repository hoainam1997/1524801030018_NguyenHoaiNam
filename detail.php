				...
				<div class="col-md-9 bor">
					...
					<section class="box-main1">
						<div class="col-md-6 text-center">
							<img src="<?php echo base_url() ?>sanpham/large/<?= $product['hinh'] ?>" class="img-responsive bor" id="imgmain" width="100%" height="370" data-zoom-image="images/16-270x270.png">
						...
						<li>
							<b class="price"><a href="<?= base_url() ?>addcart.php?id=<?= $product['id'] ?>" class="btn btn-default"> <i class="fa fa-shopping-basket"></i>Thêm vào giỏ hàng</a></b></li><b class="price">
							</b></ul><b class="price">
							</b></div><b class="price">
