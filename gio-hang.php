							...
							<tbody>
								...
								foreach ($_SESSION['cart'] as $key => $value) :
									...
									<tr>
										...
										<td>
											<a href="" class="btn btn-info update-cart" data-key = <?= $key ?>><i class="fa fa-refresh"></i> Cập nhật</a>
											<a href="remove_cart.php?key=<?= $key ?>" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i></i> Xóa</a>
										</td>
									</tr>
									<?php
